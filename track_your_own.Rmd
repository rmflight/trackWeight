...
To setup a spreadsheet of your own, first generate the dates that you are interested
in to save to a file and copy them into a Google Sheet.
...
To read your spreadsheet, you need to share it. The easiest way to do this is
by creating a sharing link, and then modifying it.
